...
function OrderCount({id, itemType}) {
  ...
  return (
    <div className="hidden lg:flex items-center justify-center h-6 w-14 px-8 bg-white hover:bg-gray-300 text-gray-800 font-bold  rounded border border-gray-400">
